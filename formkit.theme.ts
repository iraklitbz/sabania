...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:button__input": {
    ...
    "border": true,
    "border-saba-primary": true,
    "text-saba-primary": true,
  ...
  "family:text__inner": {
    ...
    "rounded-full": true,
    "border": true,
    "border-saba-primary/10": true,
    "bg-saba-primary/5": true,
    "focus-within:ring-1": true,
    "focus-within:!ring-saba-primary": true,
    "focus-within:!border-saba-primary": true,
  ...
  "family:text__input": {
    ...
    "bg-transparent": true,
    "selection:bg-blue-100": true,
    "placeholder:text-saba-primary/50": true,
    "group-data-[disabled]:!cursor-not-allowed": true,
    "border-none": true,
    "p-0": true,
    "focus:ring-0": true
  ...
  "submit__input": {
    ...
    "selection:text-neutral-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "bg-saba-primary": true,
    "!text-white": true,
    "active:text-white": true,
    "active:bg-saba-dark": true,
    "hover:bg-saba-dark": true,
