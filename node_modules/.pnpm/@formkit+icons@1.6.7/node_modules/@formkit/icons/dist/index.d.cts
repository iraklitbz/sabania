...
declare const _default$25: "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 46 80\" fill=\"currentColor\"><path d=\"M0,72c0-4.4,3.6-8,8-8s8,3.6,8,8-3.6,8-8,8-8-3.6-8-8ZM0,40c0-4.4,3.6-8,8-8s8,3.6,8,8-3.6,8-8,8S0,44.4,0,40ZM0,8C0,3.6,3.6,0,8,0s8,3.6,8,8-3.6,8-8,8S0,12.4,0,8ZM30,72c0-4.4,3.6-8,8-8s8,3.6,8,8-3.6,8-8,8-8-3.6-8-8ZM30,40c0-4.4,3.6-8,8-8s8,3.6,8,8-3.6,8-8,8-8-3.6-8-8ZM30,8c0-4.4,3.6-8,8-8s8,3.6,8,8-3.6,8-8,8-8-3.6-8-8Z\"/></svg>";
 ...
 * @public
 */
declare function createIconPlugin(icons: Record<any, string>): (node: FormKitNode) => void;

declare const paymentIcons: {
    amex: string;
    discover: string;
    mastercard: string;
    paypal: string;
...
declare const directionalIcons: {
    arrowDown: string;
    arrowLeft: string;
    arrowRight: string;
    arrowUp: string;
...
declare const applicationIcons: {
    bitcoin: string;
    bnb: string;
    cardano: string;
    dogecoin: string;
