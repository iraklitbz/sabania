  ...
  <div class="flex min-h-[calc(100vh-4rem)] justify-center px-4 py-20">
    <div class="w-full max-w-md">
      <div class="mb-8 text-center">
        <h1 class="font-display text-2xl font-bold text-zinc-900">Anmelden</h1>
        <p class="mt-2 text-sm text-zinc-500">Willkommen zurück! Bitte geben Sie Ihre Daten ein.</p>
      </div>
      ...
      <form class="space-y-4" @submit.prevent="handleLogin">
        ...
        <div>
          <div class="mb-1.5 flex items-center justify-between">
            <label class="text-sm font-medium text-zinc-700">Passwort</label>
...
async function handleLogin() {
  ...
  try {
    ...
    const translations: Record<string, string> = {
      "Your account email is not confirmed": "Ihre E-Mail-Adresse wurde noch nicht bestätigt",
      "Invalid identifier or password": "Ungültige E-Mail oder Passwort",
    };
    error.value = translations[msg] || msg || "Ungültige E-Mail oder Passwort";
  } finally {
    loading.value = false;
  }
}
