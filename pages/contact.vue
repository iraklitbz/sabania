        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-24 lg:grid-cols-2">
          <div class="lg:order-last" style="opacity: 1; transform: none;">
            <form data-np-autofill-form-type="identity" data-np-checked="1" data-np-watching="1">
              <h2 class="font-display text-base font-semibold text-neutral-950">Write us</h2>
          ...
          <div style="opacity: 1; transform: none;">
            ...
            <ul role="list" class="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-2">
              <li>
                <address class="text-sm not-italic text-neutral-600"><strong class="text-neutral-950">Jadraque</strong><br>cataperdiz 38<br>19240, Jadraque</address>
              </li>
            </ul>
            <div class="mt-16 pt-16 relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
              ...
              <dl class="mt-6 grid grid-cols-1 gap-8 text-sm sm:grid-cols-2">
                <div>
                  ...
                  <dd><a class="text-neutral-600 hover:text-neutral-950" href="mailto:careers@studioagency.com">hola@sabania.com</a></dd>
                </div>
                <div>
                  <dt class="font-semibold text-neutral-950">Office</dt>
                  <dd><a class="text-neutral-600 hover:text-neutral-950" href="mailto:press@studioagency.com">hola@sabania.com</a></dd>
                </div>
              </dl>
            </div>
            <div class="mt-16 pt-16 relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
